...
routing_waypoint_all_of_instance = RoutingWaypointAllOf.from_json(json)
# print the JSON string representation of the object
print RoutingWaypointAllOf.to_json()

# convert the object into a dict
routing_waypoint_all_of_dict = routing_waypoint_all_of_instance.to_dict()
# create an instance of RoutingWaypointAllOf from a dict
routing_waypoint_all_of_form_dict = routing_waypoint_all_of.from_dict(routing_waypoint_all_of_dict)
```
