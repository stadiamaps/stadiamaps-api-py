...
class BaseTraceRequest(BaseModel):
    ...
    __properties = ["id", "shape", "encoded_polyline", "costing", "costing_options", "shape_match", "directions_options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseTraceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseTraceRequest:
        """Create an instance of BaseTraceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseTraceRequest.parse_obj(obj)

        _obj = BaseTraceRequest.parse_obj({
            "id": obj.get("id"),
