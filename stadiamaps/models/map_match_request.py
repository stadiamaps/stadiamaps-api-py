...
class MapMatchRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "shape", "encoded_polyline", "costing", "costing_options", "date_time", "shape_match", "units", "language", "directions_type", "format", "banner_instructions", "voice_instructions", "filters", "begin_time", "durations", "use_timestamps", "trace_options", "linear_references", "elevation_interval"]
