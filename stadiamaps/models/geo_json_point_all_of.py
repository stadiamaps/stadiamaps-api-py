...
class GeoJSONPointAllOf(BaseModel):
    """
    GeoJSONPointAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeoJSONPointAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeoJSONPointAllOf:
        """Create an instance of GeoJSONPointAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeoJSONPointAllOf.parse_obj(obj)

        _obj = GeoJSONPointAllOf.parse_obj({
