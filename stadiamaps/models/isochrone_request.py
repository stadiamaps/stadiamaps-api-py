...
class IsochroneRequest(BaseModel):
    ...
    locations: Annotated[List[Coordinate], Field(min_length=1, max_length=1)]
    ...
    __properties: ClassVar[List[str]] = ["id", "locations", "costing", "costing_options", "date_time", "contours", "polygons", "denoise", "generalize", "show_locations"]
