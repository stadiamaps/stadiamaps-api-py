...
class GeoJSONPolygonAllOf(BaseModel):
    """
    GeoJSONPolygonAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeoJSONPolygonAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeoJSONPolygonAllOf:
        """Create an instance of GeoJSONPolygonAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeoJSONPolygonAllOf.parse_obj(obj)

        _obj = GeoJSONPolygonAllOf.parse_obj({
