...
class TruckCostingOptions(BaseModel):
    ...
    private_access_penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=450, description="A penalty (in seconds) for accessing private roads.")
    alley_penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A penalty (in seconds) for using alleys.")
    rail_ferry_cost: Optional[StrictInt] = Field(default=300, description="The estimated cost (in seconds) when a rail ferry is encountered. Only applies to costing models that support rail ferries (auto, truck, motorcycle).")
    use_rail_ferry: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0.4, description="A measure of willingness to take rail ferries. Values near 0 attempt to avoid rail ferries, and values near 1 will favor them. Note that as some routes may be impossible without rail ferries, 0 does not guarantee avoidance of them. Only applies to auto, truck, and motorcycle costing.")
    ignore_access: Optional[StrictBool] = Field(default=False, description="If set to true, ignores access restrictions for the route.")
    ...
    exclude_cash_only_tolls: Optional[StrictBool] = Field(default=False, description="If true, avoids routes with cash-only tolls.")
    exclude_unpaved: Optional[StrictBool] = Field(default=False, description="Indicates whether or not the path may include unpaved roads. If true, the route is allowed to start and end with unpaved roads, but is not allowed to have them in the middle of the route path. Otherwise they are allowed.")
    ...
    use_distance: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0, description="A measure of preference for time vs. distance. Values near 0 (default) optimize for time, while values near 1 optimize for shortest distance.")
    closure_factor: Optional[Union[Annotated[float, Field(le=10, strict=True, ge=1)], Annotated[int, Field(le=10, strict=True, ge=1)]]] = Field(default=9, description="A factor that penalizes the cost of traversing closed edges. The value is a multiplier on the cost of a closed edge; higher values make closed edges less likely to be used.")
    ...
    axle_count: Optional[Annotated[int, Field(le=20, strict=True, ge=2)]] = Field(default=5, description="The number of axles on the truck.")
    low_class_penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=30, description="A penalty (in seconds) for using residential or service roads.")
    use_truck_route: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0, description="A measure of preference for using designated truck routes. Values near 0 (default) have no preference, while values near 1 strongly prefer truck routes.")
    hgv_no_access_penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="A penalty (in seconds) applied to roads which do not allow HGVs. This adds a penalty rather than outright blocking, allowing the router to still use these roads if no better alternative exists. The default penalty is sufficiently high.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["maneuver_penalty", "gate_cost", "gate_penalty", "country_crossing_cost", "country_crossing_penalty", "service_penalty", "service_factor", "use_living_streets", "use_ferry", "ignore_restrictions", "ignore_non_vehicular_restrictions", "ignore_oneways", "private_access_penalty", "alley_penalty", "rail_ferry_cost", "use_rail_ferry", "ignore_access", "ferry_cost", "height", "width", "toll_booth_cost", "toll_booth_penalty", "exclude_cash_only_tolls", "exclude_unpaved", "use_highways", "use_tolls", "use_tracks", "top_speed", "shortest", "ignore_closures", "include_hov2", "include_hov3", "include_hot", "alley_factor", "use_distance", "closure_factor", "length", "weight", "axle_load", "hazmat", "axle_count", "low_class_penalty", "use_truck_route", "hgv_no_access_penalty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "private_access_penalty": obj.get("private_access_penalty") if obj.get("private_access_penalty") is not None else 450,
            "alley_penalty": obj.get("alley_penalty"),
            "rail_ferry_cost": obj.get("rail_ferry_cost") if obj.get("rail_ferry_cost") is not None else 300,
            "use_rail_ferry": obj.get("use_rail_ferry") if obj.get("use_rail_ferry") is not None else 0.4,
            "ignore_access": obj.get("ignore_access") if obj.get("ignore_access") is not None else False,
            ...
            "exclude_cash_only_tolls": obj.get("exclude_cash_only_tolls") if obj.get("exclude_cash_only_tolls") is not None else False,
            "exclude_unpaved": obj.get("exclude_unpaved") if obj.get("exclude_unpaved") is not None else False,
            ...
            "use_distance": obj.get("use_distance") if obj.get("use_distance") is not None else 0,
            "closure_factor": obj.get("closure_factor") if obj.get("closure_factor") is not None else 9,
            ...
            "axle_count": obj.get("axle_count") if obj.get("axle_count") is not None else 5,
            "low_class_penalty": obj.get("low_class_penalty") if obj.get("low_class_penalty") is not None else 30,
            "use_truck_route": obj.get("use_truck_route") if obj.get("use_truck_route") is not None else 0,
            "hgv_no_access_penalty": obj.get("hgv_no_access_penalty")
        })
