...
class RouteRequest(BaseModel):
    ...
    exclude_locations: Optional[List[RoutingWaypoint]] = Field(default=None, description="This has the same format as the locations list. Locations are mapped to the closest road(s), and these road(s) are excluded from the route path computation.")
    ...
    __properties: ClassVar[List[str]] = ["units", "language", "directions_type", "format", "banner_instructions", "voice_instructions", "filters", "id", "locations", "costing", "costing_options", "date_time", "exclude_locations", "exclude_polygons", "alternates", "elevation_interval", "roundabout_exits"]
