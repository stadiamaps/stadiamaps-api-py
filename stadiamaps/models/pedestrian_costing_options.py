...
class PedestrianCostingOptions(BaseModel):
    ...
    max_distance: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Maximum total walking distance (in meters). Defaults to 100,000 for foot, 10,000 for wheelchair.")
    max_grade: Optional[Annotated[int, Field(le=90, strict=True, ge=0)]] = Field(default=None, description="Maximum grade (steepness) as a percentage. Defaults to 90 for foot, 12 for wheelchair.")
    mode_factor: Optional[Union[StrictFloat, StrictInt]] = Field(default=1.5, description="A factor that modifies the cost when transitioning between travel modes. Setting this value higher than 1 will avoid walking, while setting it lower than 1 will prefer walking.")
    elevator_penalty: Optional[StrictInt] = Field(default=5, description="A penalty (in seconds) for using an elevator.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_grade": obj.get("max_grade"),
            "mode_factor": obj.get("mode_factor") if obj.get("mode_factor") is not None else 1.5,
            "elevator_penalty": obj.get("elevator_penalty") if obj.get("elevator_penalty") is not None else 5
        })
