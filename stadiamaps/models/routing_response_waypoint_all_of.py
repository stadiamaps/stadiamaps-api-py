...
class RoutingResponseWaypointAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoutingResponseWaypointAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoutingResponseWaypointAllOf:
        """Create an instance of RoutingResponseWaypointAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoutingResponseWaypointAllOf.parse_obj(obj)

        _obj = RoutingResponseWaypointAllOf.parse_obj({
