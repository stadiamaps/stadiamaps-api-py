...
class MatrixRequest(BaseModel):
    ...
    date_time: Optional[TimeConstraintV1] = Field(default=None, description="Time-dependent routing constraint applied globally. Cannot be combined with per-waypoint `date_time` on sources/targets.")
    ...
    __properties: ClassVar[List[str]] = ["units", "language", "directions_type", "id", "sources", "targets", "costing", "costing_options", "date_time", "matrix_locations"]
