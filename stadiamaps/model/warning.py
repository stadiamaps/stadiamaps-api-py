...
class Warning(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["text", "code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["text", "code", ], str]):
