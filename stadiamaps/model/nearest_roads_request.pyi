...
class NearestRoadsRequest(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["verbose"]) -> MetaOapg.properties.verbose: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["locations", "costing", "costing_options", "verbose", "directions_options", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["costing"]) -> typing.Union['CostingModel', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["costing_options"]) -> typing.Union['CostingOptions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["verbose"]) -> typing.Union[MetaOapg.properties.verbose, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["locations", "costing", "costing_options", "verbose", "directions_options", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        costing: typing.Union['CostingModel', schemas.Unset] = schemas.unset,
        costing_options: typing.Union['CostingOptions', schemas.Unset] = schemas.unset,
        verbose: typing.Union[MetaOapg.properties.verbose, bool, schemas.Unset] = schemas.unset,
