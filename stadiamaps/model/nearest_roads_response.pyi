...
class NearestRoadsResponse(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LocateObject']:
            return LocateObject

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['LocateObject'], typing.List['LocateObject']],
    ...
    def __getitem__(self, i: int) -> 'LocateObject':
        return super().__getitem__(i)

from stadiamaps.model.locate_object import LocateObject
