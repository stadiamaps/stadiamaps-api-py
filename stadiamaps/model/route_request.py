...
class RouteRequest(
        ...
        class properties:
            ...
            class locations(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RoutingWaypoint']:
                        return RoutingWaypoint
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['RoutingWaypoint'], typing.List['RoutingWaypoint']],
                ...
                def __getitem__(self, i: int) -> 'RoutingWaypoint':
                    return super().__getitem__(i)
        
            @staticmethod
            def costing() -> typing.Type['CostingModel']:
                return CostingModel
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["costing"]) -> 'CostingModel': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["avoid_locations"]) -> MetaOapg.properties.avoid_locations: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["avoid_polygons"]) -> MetaOapg.properties.avoid_polygons: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["locations", "costing", "id", "costing_options", "avoid_locations", "avoid_polygons", "directions_options", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["costing"]) -> 'CostingModel': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["avoid_locations"]) -> typing.Union[MetaOapg.properties.avoid_locations, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["avoid_polygons"]) -> typing.Union[MetaOapg.properties.avoid_polygons, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["locations", "costing", "id", "costing_options", "avoid_locations", "avoid_polygons", "directions_options", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        avoid_locations: typing.Union[MetaOapg.properties.avoid_locations, list, tuple, schemas.Unset] = schemas.unset,
        avoid_polygons: typing.Union[MetaOapg.properties.avoid_polygons, list, tuple, schemas.Unset] = schemas.unset,
...
from stadiamaps.model.costing_model import CostingModel
...
from stadiamaps.model.routing_waypoint import RoutingWaypoint
