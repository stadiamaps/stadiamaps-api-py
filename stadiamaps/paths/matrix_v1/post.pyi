...
# body param
SchemaForRequestBodyApplicationJson = MatrixRequest


request_body_matrix_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = MatrixResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _time_distance_matrix_oapg(
        self,
    ...
    def _time_distance_matrix_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_matrix_request.serialize(body, content_type)
...
class TimeDistanceMatrix(BaseApi):
    ...
    def time_distance_matrix(
        ...
        return self._time_distance_matrix_oapg(
            body=body,
