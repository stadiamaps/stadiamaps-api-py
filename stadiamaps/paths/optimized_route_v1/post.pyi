...
# body param
SchemaForRequestBodyApplicationJson = OptimizedRouteRequest


request_body_optimized_route_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = RouteResponse
...
class BaseApi(api_client.Api):
    ...
    def _optimized_route_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_optimized_route_request.serialize(body, content_type)
...
class OptimizedRoute(BaseApi):
    ...
    def optimized_route(
        ...
        return self._optimized_route_oapg(
            body=body,
