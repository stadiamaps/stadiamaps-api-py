...
# body param
SchemaForRequestBodyApplicationJson = HeightRequest


request_body_height_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = HeightResponse
...
class BaseApi(api_client.Api):
    ...
    def _elevation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_height_request.serialize(body, content_type)
