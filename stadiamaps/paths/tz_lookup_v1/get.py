...
class TimestampSchema(
    ...
    class MetaOapg:
        format = 'int64'
        inclusive_maximum = 8200290900000
        inclusive_minimum = 0
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'lat': typing.Union[LatSchema, decimal.Decimal, int, float, ],
        'lng': typing.Union[LngSchema, decimal.Decimal, int, float, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = TzResponse
