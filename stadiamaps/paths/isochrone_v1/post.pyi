...
# body param
SchemaForRequestBodyApplicationJson = IsochroneRequest


request_body_isochrone_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = IsochroneResponse
...
class BaseApi(api_client.Api):
    ...
    def _isochrone_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_isochrone_request.serialize(body, content_type)
