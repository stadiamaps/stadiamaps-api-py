...
# body param
SchemaForRequestBodyApplicationJson = TraceAttributesRequest


request_body_trace_attributes_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = TraceAttributesResponse
...
class BaseApi(api_client.Api):
    ...
    def _trace_attributes_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_trace_attributes_request.serialize(body, content_type)
...
class TraceAttributes(BaseApi):
    ...
    def trace_attributes(
        ...
        return self._trace_attributes_oapg(
            body=body,
