...
# body param
SchemaForRequestBodyApplicationJson = RouteRequest


request_body_route_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _route_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_route_request.serialize(body, content_type)
