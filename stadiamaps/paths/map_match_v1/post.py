...
# body param
SchemaForRequestBodyApplicationJson = MapMatchRequest


request_body_map_match_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MapMatchRouteResponse
...
class BaseApi(api_client.Api):
    ...
    def _map_match_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_map_match_request.serialize(body, content_type)
