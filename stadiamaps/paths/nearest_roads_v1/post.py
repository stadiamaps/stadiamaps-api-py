...
# body param
SchemaForRequestBodyApplicationJson = NearestRoadsRequest


request_body_nearest_roads_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = NearestRoadsResponse
...
class BaseApi(api_client.Api):
    ...
    def _nearest_roads_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_nearest_roads_request.serialize(body, content_type)
...
class NearestRoads(BaseApi):
    ...
    def nearest_roads(
        ...
        return self._nearest_roads_oapg(
            body=body,
