...
class GeocodingApi:
    ...
    def autocomplete_v2(
        ...
        boundary_circle_radius: Annotated[Optional[Annotated[int, Field(le=5000, strict=True, ge=1)]], Field(description="The radius of the circle (in kilometers) to limit the search to.  NOTE: Requires the other boundary.circle parameters to take effect. Defaults to 50km if unspecified.")] = None,
    ...
    def place_details(
        self,
        ids: Annotated[List[StrictStr], Field(min_length=1, description="A list of GIDs to search for.")],
        lang: Annotated[Optional[StrictStr], Field(description="A BCP47 language tag which specifies a preference for localization of results. By default, results are in the default locale of the source data, but specifying a language will attempt to localize the results. Note that while a `langtag` (in RFC 5646 terms) can contain script, region, etc., only the `language` portion, an ISO 639 code, will be considered. So `en-US` and `en-GB` will both be treated as English.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def reverse_v2(
        ...
        boundary_gid: Annotated[Optional[StrictStr], Field(description="The GID of a region to limit the search to.  Note: these are not stable for all datasets! For example, OSM features may be deleted and re-added with a new ID.")] = None,
        boundary_country: Annotated[Optional[List[StrictStr]], Field(description="A list of comma-separated country codes in ISO 3116-1 alpha-2 or alpha-3 format. The search will be limited to these countries.")] = None,
        boundary_circle_radius: Annotated[Optional[Annotated[int, Field(le=25, strict=True, ge=1)]], Field(description="The radius of the circle (in kilometers) to limit the search to.  Defaults to 1km if unspecified.")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=25, strict=True, ge=1)]], Field(description="The maximum number of items to return from a query.")] = None,
        lang: Annotated[Optional[StrictStr], Field(description="A BCP47 language tag which specifies a preference for localization of results. There is no default value, so place names will be returned as-is, which is usually in the local language. NOTE: The Accept-Language header is also respected, and many user agents will set it automatically.")] = None,
        _request_timeout: Union[
            None,
    ...
    def search_structured(
        self,
        address: Annotated[Optional[StrictStr], Field(description="A street name and optional house number together, e.g. `11 Wall St`. If you have the data available separately, you should provide the house number and street separately.")] = None,
        house_number: Annotated[Optional[StrictStr], Field(description="A house or building number. Mutually exclusive with the `address` field. Requires `street` to also be specified.")] = None,
        street: Annotated[Optional[StrictStr], Field(description="A street name. Mutually exclusive with the `address` field.")] = None,
        unit: Annotated[Optional[StrictStr], Field(description="The apartment, suite, or unit number. Requires both `house_number` and `street` to be specified. Mutually exclusive with the `address` field.")] = None,
        neighbourhood: Annotated[Optional[StrictStr], Field(description="A smaller area within a locality, e.g. `Financial District`. Practices vary by area, but these are typically not distinct administrative units.")] = None,
        borough: Annotated[Optional[StrictStr], Field(description="A unit within a city, e.g. `Manhattan` (not widely used outside mega cities like NYC and Mexico City).")] = None,
        ...
        postalcode: Annotated[Optional[StrictStr], Field(description="A mail sorting code (e.g. a US ZIP code).")] = None,
        country: Annotated[Optional[StrictStr], Field(description="A country code in ISO 3116-1 alpha-2 or alpha-3 format.")] = None,
        focus_point_lat: Annotated[Optional[Union[Annotated[float, Field(le=90, strict=True, ge=-90)], Annotated[int, Field(le=90, strict=True, ge=-90)]]], Field(description="The latitude of the point to focus the search on. This will bias results toward the focus point. Requires `focus.point.lon`.")] = None,
        focus_point_lon: Annotated[Optional[Union[Annotated[float, Field(le=180, strict=True, ge=-180)], Annotated[int, Field(le=180, strict=True, ge=-180)]]], Field(description="The longitude of the point to focus the search on. This will bias results toward the focus point. Requires `focus.point.lat`.")] = None,
        boundary_rect_min_lat: Annotated[Optional[Union[Annotated[float, Field(le=90, strict=True, ge=-90)], Annotated[int, Field(le=90, strict=True, ge=-90)]]], Field(description="Defines the min latitude component of a bounding box to limit the search to. Requires all other `boundary.rect` parameters to be specified.")] = None,
        boundary_rect_max_lat: Annotated[Optional[Union[Annotated[float, Field(le=90, strict=True, ge=-90)], Annotated[int, Field(le=90, strict=True, ge=-90)]]], Field(description="Defines the max latitude component of a bounding box to limit the search to. Requires all other `boundary.rect` parameters to be specified.")] = None,
        ...
        :param address: A street name and optional house number together, e.g. `11 Wall St`. If you have the data available separately, you should provide the house number and street separately.
        :type address: str
        :param house_number: A house or building number. Mutually exclusive with the `address` field. Requires `street` to also be specified.
        :type house_number: str
        :param street: A street name. Mutually exclusive with the `address` field.
        :type street: str
        :param unit: The apartment, suite, or unit number. Requires both `house_number` and `street` to be specified. Mutually exclusive with the `address` field.
        :type unit: str
        :param neighbourhood: A smaller area within a locality, e.g. `Financial District`. Practices vary by area, but these are typically not distinct administrative units.
        :type neighbourhood: str
        :param borough: A unit within a city, e.g. `Manhattan` (not widely used outside mega cities like NYC and Mexico City).
        :type borough: str
        ...
        :type region: str
        :param postalcode: A mail sorting code (e.g. a US ZIP code).
        :type postalcode: str
        :param country: A country code in ISO 3116-1 alpha-2 or alpha-3 format.
        :type country: str
        :param focus_point_lat: The latitude of the point to focus the search on. This will bias results toward the focus point. Requires `focus.point.lon`.
        :type focus_point_lat: float
        :param focus_point_lon: The longitude of the point to focus the search on. This will bias results toward the focus point. Requires `focus.point.lat`.
    ...
    def _search_structured_serialize(
        ...
        if house_number is not None:
            ...
            _query_params.append(('house_number', house_number))
