...
import stadiamaps
from stadiamaps.models.trace_attributes_response_all_of import TraceAttributesResponseAllOf  # noqa: E501
from stadiamaps.rest import ApiException

class TestTraceAttributesResponseAllOf(unittest.TestCase):
    """TraceAttributesResponseAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TraceAttributesResponseAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TraceAttributesResponseAllOf`
        """
        model = stadiamaps.models.trace_attributes_response_all_of.TraceAttributesResponseAllOf()  # noqa: E501
        if include_optional :
            return TraceAttributesResponseAllOf(
                id = 'kesklinn', 
                units = 'kilometers', 
                alternate_paths = [
    ...
    def testTraceAttributesResponseAllOf(self):
        """Test TraceAttributesResponseAllOf"""
