...
class TestOsrmRoute(unittest.TestCase):
    """OsrmRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OsrmRoute:
        """Test OsrmRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OsrmRoute`
        """
        model = OsrmRoute()
        if include_optional:
            return OsrmRoute(
