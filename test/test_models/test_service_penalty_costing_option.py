...
import stadiamaps
from stadiamaps.model.service_penalty_costing_option import ServicePenaltyCostingOption
from stadiamaps import configuration


class TestServicePenaltyCostingOption(unittest.TestCase):
    """ServicePenaltyCostingOption unit test stubs"""
