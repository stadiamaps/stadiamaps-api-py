...
class TestOsrmRouteLeg(unittest.TestCase):
    """OsrmRouteLeg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OsrmRouteLeg:
        """Test OsrmRouteLeg
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OsrmRouteLeg`
        """
        model = OsrmRouteLeg()
        if include_optional:
            return OsrmRouteLeg(
